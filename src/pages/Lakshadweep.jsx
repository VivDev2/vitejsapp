          ...
          <div class="grid gap-8 md:grid-cols-2">
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/lak1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/lak2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/lak3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/lak4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/lak5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/lak6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-100">4 days 3 nights</span>
                <h2 class="text-2xl font-bold text-gray-100 lg:text-3xl">Lakshadweep </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-100 font-bold">
                <p>Lakshadweep is a another paradise for beach lovers. It is the part of Indian Union Teritory.</p><br></br>
                    Tour includes:-
                <ul>
                  <li>Hotel.</li>
                  <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-100 md:text-2xl">₹ 20000</span>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                ...
                <p class="text-gray-100 mt-3 font-bold">
                  Lakshadweep Island is situated in India to the left of Arabian Sea.<br /><br />

                  Like Andaman and Nicobar Islands, Lakshadweep Islands is also made by a combination of small tiny islands. It is very prominent for it's beautiful beaches, crysal clear water 5 star resorts and more. There are a bunch of water activities that makes travelling extra special like scooba diving, para-glyding and speed boating.<br /><br />

                  Delta Travel is a one stop destination for your travel booking that will make your travelling fully worth.
                </p>
              </div>
