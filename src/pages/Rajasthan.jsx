...
function Rajasthan() {
  return (
    <div>
      <div class="bg-yellow-200 py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
          <div class="grid gap-8 md:grid-cols-2">

            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/rajastahn3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/rajasthan2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/rajsthan1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/daldal.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/chat.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/kulfi.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-900">8 days 7 nights</span>
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">Rajasthan</h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-900 font-bold">
                <p>Experiance the world class hospitality of this beautiful state with your family, friends or with your loved once. certainly this is going to be unforgetable experiance.</p><br></br>
                Tour includes:-
                   <ul>
                       <li>Hotel.</li>
                       <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-800 md:text-2xl">₹ 26000</span>
                  <span class="mb-0.5 text-red-500 line-through">₹ 28500</span>
                </div>
              ...
              <div class="mb-6 flex items-center gap-2 text-gray-500">
                ...
                <span class="text-gray-900 font-bold">Note: We recommend you to book your tour 5 months before to prevent any inconvinience</span>
              </div>



              <div class="flex gap-2.5">
                <a href="/book" class="inline-block flex-1 rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 sm:flex-none md:text-base">book now</a>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                <div class="mb-3 mt-6 text-lg font-bold text-gray-800 ">Description</div>

                <p class="text-gray-900 mt-3 font-bold">
                  Rajasthan is the biggest state in India, it is mostly famous for its forts, deserts, castles, incredible history, hospitality and food.There are two amazing cities in Rajasthan, one is pink city called jaipur and another is blue city called jodhpur. People of rajasthan are very warm and welcoming. They always treat their guest like the supreme person that is why any person who visits Rajasthan never forgets his/her experiance life time.<br /><br />

                  Another Thing is really special about Rajasthan is their cultural dance which is quite fascination among tourist comping from abroad, and certainly even you will enjoy it too. If you will visit Rajasthan you cannot miss on their special dal bati and churma which is not only tasty but also very healthy, and also you can leave Rajasthan back without trying their authentic chats, kulfi and many more.

                  That's why you are choosing one of the finest tours you are going to experiance, delta travels always has everything ready up to the mark and that's why it never their guest's journey colorless.
                </p>
              </div>
