          ...
          <div class="grid gap-8 md:grid-cols-2">
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/andaman1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/andaman2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/andaman3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/andaman4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/andaman5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/andaman6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-900">6 days 5 nights</span>
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">Andaman and Nicobar </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-900 font-bold">
                <p>Andman and Nicobar is a groups of tiny islands which is the part of Indian union teritory.It is a paradise for beach lovers.</p><br></br>
                Tour includes:-
                   <ul>
                       <li>Hotel.</li>
                       <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-800 md:text-2xl">₹ 23000</span>
                  <span class="mb-0.5 text-red-500 line-through">₹ 26000</span>
                </div>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                ...
                <p class="text-gray-900 mt-3 font-bold">
                  Andaman and Nicobar islands is a part of Indian Union teritory which is made by combining tiny islands.It is one of the popular tourist destinations in India.<br /><br />

                  Certainly Andaman and Nicobar island is blessed with natural beauty, it has beaches, resorts, 5 star hotels and a lot of greenary. It's crystal clear water attracts thousands of tourist around the globe. Moreover it is not only a tourist destination but also it has many universities so makes it a really good tourist destination as well.<br /><br />

                  Delta travels always understands what beach lovers want that is why it will be your best trip indeed.
                </p>
              </div>
