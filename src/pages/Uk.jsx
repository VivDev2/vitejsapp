...
function  Uk() {
  return (
    <div>
      <div class="bg-red-100 py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
          <div class="grid gap-8 md:grid-cols-2">

            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/uk1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/uk2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/uk3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/uk4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/uk5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/uk6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-900">11 days 10 nights</span>
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">The United Kingdom </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-900 font-bold">
                <p>The country famous for it's fish and chips and the home of queen is extremly beautiful country in Europe .</p><br></br>
                Tour includes:-
                <ul>
                  <li>Hotel.</li>
                  <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-800 md:text-2xl">₹ 80500</span>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                ...
                <p class="text-gray-900 mt-3 font-bold">
                  The Kingdom of United Kingdom just not means England but there are few more nations which live together, and those are Scotland, Wales and Northern Ireland.<br /><br />

                  The place where cricket was originated, and is extremly famous for bigbane, Buckingham Palace and many other tourist destination that attracts tourist from all corner of the globe. It's most famous country dish fish and chips give it a global recognition and also cities like London is also famous for it's economic growth, night-life and also high quality education.<br /><br />

                  It is very commendable that this country has well preserved their hostory and culture that's why if you visit over there you can still explore the city in that black taxi. However it's reputation sometimes gets litle awkward for those people who love summers because the atmosphere is mostly cloudy throughout the year and summers are also not that big. But that doesn't mean it stops to bring tourist on their soil.
                </p>
              </div>
