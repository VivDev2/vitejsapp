          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="text-primary mb-4 block text-base font-semi-bold text-center font-bold">
                  Contact Us !
                </span>
                <h2
                  className ="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-center"
                >
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-body-color mb-9 text-base leading-relaxed text-center font-bold">
                 Feel free to contact our team if you have any queries. They will certainly assist you.
                </p>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">delta@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
