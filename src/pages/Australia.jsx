          ...
          <div class="grid gap-8 md:grid-cols-2">
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/australia1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/australia2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/australia3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/australia4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/australia5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/australia6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-900">15 days 14 nights</span>
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">Australia </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-900 font-bold">
                <p>Australia is the smallest continent in the world. No country in the world has this prvillage to hold this title.</p><br></br>
                Tour includes:-
                <ul>
                  <li>Hotel.</li>
                  <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-800 md:text-2xl">₹ 79999</span>
                  <span class="mb-0.5 text-red-500 line-through">₹ 99999</span>
                </div>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                ...
                <p class="text-gray-900 mt-3 font-bold">
                  Australia is situated in Oceania. It is a giant country but at the same time the smallest continent.But no country in the world has this privillage of holding this title except Australia.<br /><br />

                  Australia is indeed one of the beautiful countries in the world. It has a lot of natural beauty, it is one of the leat populated countries in the world and as a matter of fact there are more kangaroos in Australia than humans that is why it is there national animal. Australia has a lot of beaches.<br /><br />

                  Mega Cities in Australia like Sydney, Melbourne, Brisbane, Adelaide, Perth and Gold Coast are Amazing cities of the country. Sydney Operah House in Sydney attracts millions of tourist around the world, Every Australian city has their own beaches so makes it a perfect destination during summers and as a fun fact summers in Australia are more prominent in November and December. So this makes Australia a lot different than world.
                </p>
              </div>
