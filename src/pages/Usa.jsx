...
function Usa() {
  return (
    <div>
      <div class="bg-gray-500 py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
          <div class="grid gap-8 md:grid-cols-2">

            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/usa1.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/usa2.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/usa3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/usa4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/usa5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/usa6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                <span class="mb-0.5 inline-block text-gray-100">18 days 17 nights</span>
                <h2 class="text-2xl font-bold text-gray-100 lg:text-3xl">United States of America </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-100 font-bold">
                <p>United States of America is the world's third larget country, it is situated in North America and borders three countries i.e. Canada, Mexico and Russia.</p><br></br>
                Tour includes:-
                <ul>
                  <li>Hotel.</li>
                  <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-100 md:text-2xl">₹ 99999</span>
                  <span class="mb-0.5 text-red-500 line-through">₹ 120000</span>
                </div>
              ...
              <div class="mb-6 flex items-center gap-2 text-gray-500">
                ...
                <span class="text-gray-100 font-bold">Note: We recommend you to book your tour 5 months before to prevent any inconvinience.</span>
              </div>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                <div class="mb-3 mt-6 text-lg font-bold text-gray-100 ">Description</div>

                <p class="text-gray-100 mt-3 font-bold">
                  The United States of America is a giant nation situated in the continent of North America. It consist of 50 States and it's capital is Washington DC.<br /><br />

                  United States of America is a dream for thouands of people because of it's culture and it's tourist destination. Whenever we see any hollywood movie, we tend to see only New York and Los Angeles. However, The US is so big that there are probably endless things to see and explore.<br /><br />

                  The US is very energetic country that believes in self-made concept that's why it is one of the leading countries in the world. Also US is not just big scyscrappers but also you can also explore desserts, mountains, lakes, rivers, beaches, snow and more. that's where delta travel comes to you with an amazing package that will make your trip unforgettable.
                </p>
              </div>
