...
function Kashmir() {
  return (
    <div>
      <div class="bg-blue-100 py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
          <div class="grid gap-8 md:grid-cols-2">

            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/kashmir3.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/kashmir5.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/kashmir2.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div class="relative overflow-hidden rounded-lg bg-gray-100">
                <img src="/kashmir4.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/kashmir1.jpg" class="h-full w-full object-cover object-center" />
                </div>

                <div class="overflow-hidden rounded-lg bg-gray-100">
                  <img src="/kashmir6.jpg" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                </div>
              </div>
            </div>
            ...
            <div class="md:py-8">
              ...
              <div class="mb-2 md:mb-3">
                ...
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl">Kashmir </h2>
              </div>
              ...
              <div class="mb-4 md:mb-6 text-gray-900 font-bold">
                <p>If you ask what's the heaven on earth, the straight away anser is kashmir. A place where indeed melts everyone's heart.</p><br></br>
                Tour includes:-
                   <ul>
                       <li>Hotel.</li>
                       <li>Meals.</li>
              ...
              <div class="mb-4">
                <div class="flex items-end gap-2">
                  <span class="text-xl font-bold text-gray-800 md:text-2xl">₹ 29000</span>
                  <span class="mb-0.5 text-red-500 line-through">₹ 33000</span>
                </div>
              ...
              <div class="mt-10 md:mt-16 lg:mt-20">
                ...
                <p class="text-gray-900 mt-3 font-bold">
                  Kashmir is situated in North India. It is indeed a heaven on earth attracting thousands of tourist.<br /><br />

                  Kashmir is blessed with natural beauty, it's snowy mountauns and a lot grennary and with so many gardens and lakes it is not just enough to visit this state once.<br /><br />

                  Every place in Kasmir has something special, kashmiri people are extreamly hospitable, and every tourist who visits there never regrets in their entire life. Infact some people call it switzerland of India, however it is very different. Kashmiri quizine is very unique in itslef. Their food quality is unmatable, there most famous kashmiri pulav which is a rice dish with vegetables and a bit sweet in taste will definitely blow your mind. Kashmir is also famous for its houseboat which is in Sri Nagar in Dal Lake is absolutely amazing and will never go from your memory, their are so many famous bollywood movies who have done their movie shootings in Kashmir. That shows how specialt is. Certainly a trip with Delta travels will indeed make your travel fully worth.
                </p>
              </div>
